...
insert into CUSTOMER values('karthikR','karthik','rao','Harohalli',9880012292,'karthik','karthik.e1998@gmail.com');
insert into CUSTOMER values('DivyaB','Divya','Ramadas','T.R.Nagar',8147088394,'divya','divyab@gmail.com');
insert into CUSTOMER values('ChaitanyaN','Chaitanya','N','Padhmanabh Nagar',9902908189,'chaitanya','chaitanya@gmail.com');
insert into CUSTOMER values('RamadasGB','Ramadas','Bhandari','T.R.Nagar',9449567841,'ram','ramadas@gmail.com');
insert into CUSTOMER values('JayantiH','Jayanti','hegde','Hanumanthnagar',8151817105,'jaya','jayanti@gmail.com');
...
insert into ADMIN values(1,'pooja',19,'F','poojashree@gmail.com','pooja');
insert into ADMIN values(2,'pranitha',19,'F','pranitha@gmail.com','prani');
...
insert into SMARTCARD values(123,150.0,'Issued','karthikR',2);
insert into SMARTCARD values(124,50.0,'Processing','DivyaB',1);
insert into SMARTCARD values(125,150.0,'Issued','RamadasGB',1);
insert into SMARTCARD values(126,50.0,'Pending','ChaitanyaN',1);
insert into SMARTCARD values(127,150.0,'Processing','JayantiH',2);
...
insert into COMPLAINT values(1,'train delay','there is atrain delay','Not_Replied','karthikR');
insert into COMPLAINT values(2,'elevator problem','there is a problem in elevators','Not_Replied','DivyaB');
insert into COMPLAINT values(3,'lift problem','there is a heavy rush in the lifts','not_replied','chaitanyaN');
...
insert into REPLY values(1,'we will manage trains',1,1);
insert into REPLY values(2,'we provide lifts',2,2);
insert into REPLY values(3,'we will try to provide extra lifts',1,3);
